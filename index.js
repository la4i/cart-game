...
function handleClick(cardIndex) {
  ...
  if (flippedCards.length === 2 && flippedCards[0].rank === flippedCards[1].rank && flippedCards[0].suit === flippedCards[1].suit) {
...
function generateCardImages(totalCards) {
  ...
  document.getElementById('medium').addEventListener('click', () => selectLevel('medium'));
