...
const onCardClick = (elem, suit, rank, hiddenImg) => {
    ...
    for (let index = 0; index < 2; index++) {
        ...
        miniCardSuit.classList.add('suitMini');
        ...
        if (index === 0) {
            cardTopRankContainer.classList.add('cardTopRankContainer');
            cardTopRankContainer.append(rankNumber, miniCardSuit);
        } else {
            cardBottomRankContainer.classList.add('cardBottomRankContainer');
            ...
            modalWrapper.innerHTML += `
                <div class="modalBg">
                    <div class="modal">
                        ...
                        <h2 class="modalTitle">Вы выиграли!</h2>
                        <p class="timerTitle">Затраченное время:</p>
                        <h1 class="timerCount">${timer.innerHTML}</h1>
            ...
            modalWrapper.innerHTML += `
                <div class="modalBg">
                    <div class="modal">
                        ...
                        <h2 class="modalTitle">Вы проиграли!</h2>
                        <p class="timerTitle">Затраченное время:</p>
                        <h1 class="timerCount">${timer.innerHTML}</h1>
                        <button class="btn playAgain">Играть снова</button>
                    </div>
